...
export const RECIPES: Recipe[] = [
  {
    id: 1, name: 'Classic Vanilla', category: 'Classic', image: 'images/classic-vanilla.png', icon: '🍰', theme: 'vanilla',
  ...
  {
    id: 2, name: 'Chocolate Truffle', category: 'Chocolate', image: 'images/chocolate-truffle.png', icon: '🍫', theme: 'chocolate',
  ...
  {
    id: 3, name: 'Red Velvet', category: 'Classic', image: 'images/red-velvet.png', icon: '❤️', theme: 'red-velvet',
  ...
  {
    id: 4, name: 'Black Forest', category: 'Chocolate', image: 'images/black-forest.png', icon: '🍒', theme: 'black-forest',
  ...
  {
    id: 5, name: 'Fresh Strawberry', category: 'Fruit', image: 'images/fresh-strawberry.png', icon: '🍓', theme: 'strawberry',
  ...
  {
    id: 6, name: 'Pineapple Cream', category: 'Fruit', image: 'images/pineapple-cream.png', icon: '🍍', theme: 'pineapple',
  ...
  {
    id: 7, name: 'Eggless Vanilla', category: 'Eggless', image: 'images/eggless-vanilla.png', icon: '🌼', theme: 'vanilla',
  ...
  {
    id: 8, name: 'Eggless Chocolate', category: 'Eggless', image: 'images/eggless-chocolate.png', icon: '🍫', theme: 'chocolate',
  ...
  {
    id: 9, name: 'Butterscotch', category: 'Classic', image: 'images/butterscotch.png', icon: '✨', theme: 'butterscotch',
  ...
  {
    id: 10, name: 'Carrot Walnut', category: 'Classic', image: 'images/carrot-walnut.png', icon: '🥕', theme: 'carrot',
  ...
  {
    id: 11, name: 'Lemon Drizzle', category: 'Fruit', image: 'images/lemon-drizzle.png', icon: '🍋', theme: 'lemon',
  ...
  {
    id: 12, name: 'Blueberry', category: 'Fruit', image: 'images/blueberry.png', icon: '🫐', theme: 'blueberry',
  ...
  {
    id: 13, name: 'Coffee Mocha', category: 'Chocolate', image: 'images/coffee-mocha.png', icon: '☕', theme: 'coffee',
  ...
  {
    id: 14, name: 'Coconut', category: 'Classic', image: 'images/coconut.png', icon: '🥥', theme: 'coconut',
  ...
  {
    id: 15, name: 'Mango Cream', category: 'Fruit', image: 'images/mango-cream.png', icon: '🥭', theme: 'mango',
  ...
  {
    id: 16, name: 'Orange', category: 'Fruit', image: 'images/orange.png', icon: '🍊', theme: 'orange',
  ...
  {
    id: 17, name: 'KitKat Chocolate', category: 'Chocolate', image: 'images/kitkat-chocolate.png', icon: '🍫', theme: 'kitkat',
  ...
  {
    id: 18, name: 'Eggless Banana', category: 'Eggless', image: 'images/eggless-banana.png', icon: '🍌', theme: 'banana',
  ...
  {
    id: 19, name: 'Eggless Rasmalai', category: 'Eggless', image: 'images/eggless-rasmalai.png', icon: '🌸', theme: 'rasmalai',
  ...
  {
    id: 20, name: 'Marble Cake', category: 'Classic', image: 'images/marble-cake.png', icon: '🌀', theme: 'marble',
